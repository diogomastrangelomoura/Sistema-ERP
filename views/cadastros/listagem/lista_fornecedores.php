...
<div class="sl-pagebody">
          ...
          <div class="row">
                <div class="col-md-9">
                  <h6 class="card-body-title">Fornecedores cadastrados</h6>
                  <p class="mg-b-20 mg-sm-b-30 upper letras_finas">Para editar o cadasto o clique no ícone </p>
                </div>

                <div class="col-md-3">
                  <a  href="cadastros/fornecedores/novo" class="btn btn-info pull-right upper letras_finas botao-mobile">Novo Fornecedor</a>
                </div>  
           </div>   
